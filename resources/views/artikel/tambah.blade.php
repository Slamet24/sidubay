...
<div class="layout-px-spacing">
    ...
    <div class="card mt-4">
        <div class="card-body">
            <form method="post" action="{{ url('admin/artikel/tambah') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Judul Artikel</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="judul" aria-describedby="emailHelp" value="{{ old('judul') }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleInputEmail1" name="deskripsi" aria-describedby="emailHelp">{{ old('deskripsi') }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="kategori" id="kategori1" value="umum">
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="kategori" id="kategori1" value="info">
                            <label class="form-check-label" for="kategori1">
                                Info
                            </label>
                        </div>
